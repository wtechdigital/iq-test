...
export function MaterialSymbolsTimerOutline1(props: SVGProps<SVGSVGElement>) {
...
export const Opportunities = ({ setStep }: Props) => {
  ...
  <div className="flex items-center justify-center w-full max-w-xl mx-auto">
      ...
      <div className="flex  flex-col gap-1 py-0 lg:mt-4 text-center px-0">
        ...
        base: "bg-teal-700/10"
              ...
              <div className="flex items-center">
                <MaterialSymbolsTimerOutline1 className="w-5 h-5 text-black" />
      ...
      <div className="gap-1 px-0 pt-0">
        ...
        <div className="w-full mt-10 px-5 flex-wrap gap-4  flex items-center justify-center ">
          <Pagination showControls isCompact total={30} initialPage={2} 
                 classNames={{
                  cursor:
                    "bg-teal-700",
                }} 
